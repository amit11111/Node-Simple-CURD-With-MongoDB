...
transporter.verify((error) => {
  if (error) {
    console.log('error with email connection'); // eslint-disable-line
  }
});
...
exports.sendPasswordReset = async (passwordResetObject) => {
  ...
  email
    ...
    .catch(() => console.log('error sending password reset email')); // eslint-disable-line
};
...
exports.sendPasswordChangeEmail = async (user) => {
  ...
  email
    ...
    .catch(() => console.log('error sending change password email')); // eslint-disable-line
};
